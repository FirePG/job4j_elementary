...
public class Converter {
    ...
    public static void main(String[] args) {
        ...
        passed = expected == out;
        System.out.println("140 rubles are 7 dollars. Test result : " + passed);
        expected = 280;
        out = Converter.euroToDollar(in);
        passed = expected == out;
        System.out.println("140 euro are 280 dollars. Test result : " + passed);
        expected = 70;
        out = Converter.dollarToEuro(in);
        passed = expected == out;
        System.out.println("140 dollars are 70 euro. Test result : " + passed);
